...
--
-- The game's modules use production-style requires (game.ReplicatedStorage.X,
-- and script-relative requires for children). To make those resolve inside the
-- runtests place, clone the game code out of this plugin into the DataModel.
-- Specs should also require modules via game.ReplicatedStorage so that all
-- code shares the single installed copy of each module.
--------------------------------------------------------------------------------
